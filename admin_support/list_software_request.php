...
<div class="table">
 ...
 {
	 $WhereQuery=" where admin_comment!='' and approve_status=0 and (sales_comment is null or software_status=2) and acc_manager IN ('pankaj','jaipurrequest','asaleslogin','ksaleslogin','msaleslogin','jsaleslogin','sanjeeb','jaipursales','khetraj')";
 }
 ...
 { 
	 $WhereQuery=" where approve_status=0  and (admin_comment is null or sales_comment!='') and software_status=1 and acc_manager IN ('pankaj','jaipurrequest','asaleslogin','ksaleslogin','msaleslogin','jsaleslogin','sanjeeb','jaipursales','khetraj') and (forward_req_user is null or forward_back_comment!='')";
