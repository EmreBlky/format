...
<div class="top-bar">
 ...
 {
	 $WhereQuery=" where admin_comment!='' and renew_dimts_status=2 and acc_manager!='triloki'";
 }
 ...
 { 
	 $WhereQuery=" where approve_status=0 and acc_manager!='triloki' and (payment_status!='') and (admin_comment is null or service_comment!='') and renew_dimts_status=1 and (forward_req_user is null or forward_back_comment!='')";
