...
{
	$Updateapprovestatus="update internalsoftware.new_account_creation set approve_status=1,approve_date='".date("Y-m-d H:i:s")."' where id=".$row_id;
	select_query($Updateapprovestatus);
	echo "Successfully Approved";
}
  ...
  <div class="dataleft">
    <table cellspacing="2" cellpadding="2">
      <tbody>
        ...
        <tr>
          <td>Demo Period</td>
          <td><? if($row[0]["demo_time"]!=""){echo $row[0]["demo_time"]." Days";}?> </td>
        </tr>
        <tr>
          <td>FOC Reason</td>
