...
if($_POST["Showrequest"]==1)
 ...
 {
	 $WhereQuery=" where  admin_comment!='' or forward_comment!=''  and approve_status=0 and (sales_comment is null or discount_status=2) and acc_manager IN ('pankaj','jaipurrequest','asaleslogin','ksaleslogin','msaleslogin','jsaleslogin','sanjeeb','jaipursales','khetraj')";
 }
