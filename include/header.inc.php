...
<html>
	<head>
		...
		<link  href="<?php echo __SITE_URL;?>/css/mycss.css" rel="stylesheet" type="text/css" />
...
<!--  <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"> </script> 
 -->		<style type="text/css" title="currentStyle">
    ...
    <script type="text/javascript" src="<?php echo __SITE_URL;?>/build/jquery.datetimepicker.full.js"></script>
    ...
    <link type="text/css" href="<?php echo __SITE_URL;?>/css/demos.css" rel="stylesheet" />
     <link rel="stylesheet" type="text/css" href="<?php echo __SITE_URL;?>/jquery.datetimepicker.css"/>  
	...
	<link href="<?php echo __SITE_URL;?>/css/jquery.multiselect.css" rel="stylesheet" type="text/css">
