...
if($action=='edit' or $action=='editp')
	{
	$result=mysql_fetch_array(mysql_query("select * from deactivation_of_account where id=$id"));	
	}
?> 
  ...
  ?>
        ...
        <tr>
            ...
            <td>
             ...
             <Input type = 'Radio' Name ='deviceremove'    value= 'Y' <?php if($result['device_remove_status']=="Y"){echo "checked=\"checked\""; }?> onchange="Statuschange(this.value)">Yes
            
            <Input type = 'Radio' Name ='deviceremove'    value= 'N' <?php if($result['device_remove_status']=="N"){echo "checked=\"checked\""; }?> onchange="Statuschange(this.value)" >No</td>
        </tr>
        <tr>
        	<td colspan="2">
		  ...
		  <table  id="devicerecord1" style=";width: 300px; border:1" cellspacing="5" cellpadding="5">
			<tr>
             <td width="300px"> No of Removed Device</td>
              <td>
                <select name="no_of_removed_devices" id="no_of_removed_devices">
                    <option value="">-- Select One --</option>
                     <option value ="1"<?php if($result['no_of_removed_devices']=='1'){ echo "selected=selected";} ?>>1</option>
                     <option value ="2"<?php if($result['no_of_removed_devices']=='2'){ echo "selected=selected";} ?>>2</option>
                     <option value ="3"<?php if($result['no_of_removed_devices']=='3'){ echo "selected=selected";} ?>>3</option>
                     <option value ="4"<?php if($result['no_of_removed_devices']=='4'){ echo "selected=selected";} ?>>4</option>
                     <option value ="5"<?php if($result['no_of_removed_devices']=='5'){ echo "selected=selected";} ?>>5</option>
                     <option value ="6"<?php if($result['no_of_removed_devices']=='6'){ echo "selected=selected";} ?>>6</option>
                     <option value ="7"<?php if($result['no_of_removed_devices']=='7'){ echo "selected=selected";} ?>>7</option>
                     <option value ="8"<?php if($result['no_of_removed_devices']=='8'){ echo "selected=selected";} ?>>8</option>
                     <option value ="9"<?php if($result['no_of_removed_devices']=='9'){ echo "selected=selected";} ?>>9</option>
                     <option value ="10"<?php if($result['no_of_removed_devices']=='10'){ echo "selected=selected";} ?>>10</option>
                     <option value ="11"<?php if($result['no_of_removed_devices']=='11'){ echo "selected=selected";} ?>>11</option>
                     <option value ="12"<?php if($result['no_of_removed_devices']=='12'){ echo "selected=selected";} ?>>12</option>
                     <option value ="13"<?php if($result['no_of_removed_devices']=='13'){ echo "selected=selected";} ?>>13</option>
                     <option value ="14"<?php if($result['no_of_removed_devices']=='14'){ echo "selected=selected";} ?>>14</option>
                     <option value ="15"<?php if($result['no_of_removed_devices']=='15'){ echo "selected=selected";} ?>>15</option>
                     <option value ="16"<?php if($result['no_of_removed_devices']=='16'){ echo "selected=selected";} ?>>16</option>
                     <option value ="17"<?php if($result['no_of_removed_devices']=='17'){ echo "selected=selected";} ?>>17</option>
                     <option value ="18"<?php if($result['no_of_removed_devices']=='18'){ echo "selected=selected";} ?>>18</option>
                     <option value ="19"<?php if($result['no_of_removed_devices']=='19'){ echo "selected=selected";} ?>>19</option>
                     <option value="20"<?php if($result['no_of_removed_devices']=='20'){ echo "selected=selected";} ?>>20</option>
                     <option value ="21"<?php if($result['no_of_removed_devices']=='21'){ echo "selected=selected";} ?>>21</option>
                     <option value ="22"<?php if($result['no_of_removed_devices']=='22'){ echo "selected=selected";} ?>>22</option>
                     <option value ="23"<?php if($result['no_of_removed_devices']=='23'){ echo "selected=selected";} ?>>23</option>
                     <option value ="24"<?php if($result['no_of_removed_devices']=='24'){ echo "selected=selected";} ?>>24</option>
                     <option value ="25"<?php if($result['no_of_removed_devices']=='25'){ echo "selected=selected";} ?>>25</option>
                     <option value ="26"<?php if($result['no_of_removed_devices']=='26'){ echo "selected=selected";} ?>>26</option>
                     <option value ="27"<?php if($result['no_of_removed_devices']=='27'){ echo "selected=selected";} ?>>27</option>
                     <option value ="28"<?php if($result['no_of_removed_devices']=='28'){ echo "selected=selected";} ?>>28</option>
                     <option value ="29"<?php if($result['no_of_removed_devices']=='29'){ echo "selected=selected";} ?>>29</option>
                     <option value ="30"<?php if($result['no_of_removed_devices']=='30'){ echo "selected=selected";} ?>>30</option>
                     <option value ="31"<?php if($result['no_of_removed_devices']=='31'){ echo "selected=selected";} ?>>31</option>
                     <option value ="32"<?php if($result['no_of_removed_devices']=='32'){ echo "selected=selected";} ?>>32</option>
                     <option value ="33"<?php if($result['no_of_removed_devices']=='33'){ echo "selected=selected";} ?>>33</option>
                     <option value ="34"<?php if($result['no_of_removed_devices']=='34'){ echo "selected=selected";} ?>>34</option>
                     <option value ="35"<?php if($result['no_of_removed_devices']=='35'){ echo "selected=selected";} ?>>35</option>
                     <option value ="36"<?php if($result['no_of_removed_devices']=='36'){ echo "selected=selected";} ?>>36</option>
                     <option value ="37"<?php if($result['no_of_removed_devices']=='37'){ echo "selected=selected";} ?>>37</option>
                     <option value ="38"<?php if($result['no_of_removed_devices']=='38'){ echo "selected=selected";} ?>>38</option>
                     <option value ="39"<?php if($result['no_of_removed_devices']=='39'){ echo "selected=selected";} ?>>39</option>
                     <option value="40"<?php if($result['no_of_removed_devices']=='40'){ echo "selected=selected";} ?>>40</option>
                </select>
                </td>
			  </tr>
		</table>
       ...
       <table cellspacing="5" cellpadding="5" style=" padding-left: 100px;width: 500px;" >
        ...
        <tr>
            ...
            <td>
             ...
             <Input type = 'Radio' Name ='deactivateStatus'    value= 'temporary' <?php if($result['deactivate_temp']=="temporary"){echo "checked=\"checked\""; }?>
            onchange="Status(this.value)"
            >Temporary
            
            <Input type = 'Radio' Name ='deactivateStatus'    value= 'Permanent' <?php if($result['deactivate_temp']=="Permanent"){echo "checked=\"checked\""; }?>
            onchange="Status(this.value)"
            >Permanent</td>
        </tr>

       <?php if($result['deactivate_temp']=="temporary") { ?>
	...
	<tr>
             ...
             <td> <label  id="lbDlDate">Alert Date</label></td>
			  <td> <input type="text" name="alert_date" id="datepicker" value="<?=$result['alert_date']?>" /></td>
			  </tr>
		</table>
		<? } ?>
		...
		<?php if($result['deactivate_temp']=="Permanent") { ?>
		 		  <table  id="Permanentsat1" align="center"  style="width: 200px; border:1" cellspacing="5" cellpadding="5">

        <tr>
            <td>
    
            <Input type = 'Radio' Name ='DeleteFromDebtors'    value= 'Yes' <?php if($result['delete_form_debtors']=="Yes"){echo "checked=\"checked\""; }?> />
            Delete From Debtors
            </td></tr>
            </table>
		<? } ?>
