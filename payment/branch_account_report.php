...
include($_SERVER['DOCUMENT_ROOT']."/format/include/leftmenu_payment.php");
    ...
    <table style="padding-left: 100px;width: 500px;" cellspacing="5" cellpadding="5">
        ...
        <tr>
            ...
            <td>
                ...
                <?php
                $main_user_id=mysql_query("SELECT id as user_id, sys_username as name FROM matrix.users where sys_active=1 order by name asc",$dblink);
