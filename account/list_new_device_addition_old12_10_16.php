        ...
        <td>
        	<table>
            	<tr>
					...
					<td align="center"> <input type="submit" name="addByTime" value="submit" /></td>
                </tr>
            </table>
        </td>
	</tr>
...
<div class="table">
<?php
if(isset($_POST['addByTime']))
{
	//echo $_POST[fromTime]; 
	 $time1=date("Y-m-d",strtotime($_POST[FromDate]))." 00:00:00";
	 $time2=date("Y-m-d",strtotime($_POST[ToDate]))." 23:59:59"; 
	...
	{ 
		...
		//echo "SELECT * FROM new_device_addition ". $WhereQuery." order by date DESC"; die;
...
else
{
	...
	$query = select_query("SELECT * FROM new_device_addition ". $WhereQuery." order by date DESC limit 500");
}
