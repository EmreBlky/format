...
<div class="top-bar">
  ...
  <a href="pending_debtor.php" class="button">ADD Pending </a> 
  <!--<a href="received_debtor.php" class="button">ADD Received </a>-->
...
?>
    ...
    <tr align="center">
        ...
        <td>
        	<a href="#" onClick="Show_record(<?php echo $query[$i]["client_id"];?>,'debtor_show','popup1'); " class="topopup">View Detail</a>
           <? if($total_amount > 0 ) { ?> 
            | <a href="received_debtor.php?company=<?=$query[$i]["company_name"];?>&manager=<?=$query[$i]["manager"];?>&agent=<?=$query[$i]["agent"];?>&client=<?=$query[$i]["client_id"];?>&AddRecd=true">ADD Received </a> 
            <? } ?>
            </td>
      </tr>
      <?php } ?>
