  ...
  <div align="center">
    <form name="myformlisting" method="post" action="">
      <select name="Showrequest" id="Showrequest" onchange="form.submit();" >
        ...
        <option value="4" <?if($_POST['Showrequest']==4){ echo "Selected"; }?>>Billing Yes</option>
...
if($_POST["Showrequest"]==1)
 ...
 {
	 $WhereQuery=" where billing='Yes'";
 }
  else if($_POST["Showrequest"]==5)
 {
	 $WhereQuery=" where approve_status=0 and final_status!=1 and (pay_status!='' or account_comment!='' or forward_back_comment!='')";
 }
 else
 { 
	  
	 $WhereQuery=" where (approve_status=0 and final_status!=1 and pay_status is null and account_comment is null and rdd_reason!='') or (forward_req_user='".$_SESSION["user_name"]."' and (forward_back_comment is null or forward_back_comment=''))";
