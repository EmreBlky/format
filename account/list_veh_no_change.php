...
$.ajax({
		type:"GET",
		url:"userInfo.php?action=VehNoChangePaymentClear",
 		data:"row_id="+row_id,
...
$.ajax({
		type:"GET",
		url:"userInfo.php?action=VehNoChangePaymentPending",
...
if($_POST["Showrequest"]==1)
 ...
 {
	 $WhereQuery=" where approve_status=0 and final_status!=1 and (payment_status!='' or account_comment!='' or forward_back_comment!='')";
 }
 else
 { 
	  
	/* $WhereQuery=" where (approve_status=0 and final_status!=1 and payment_status is null and account_comment is null) or (forward_back_comment is null and forward_req_user='".$_SESSION["user_name"]."')";*/
