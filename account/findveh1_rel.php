...
$query="SELECT sim_no,veh_no FROM reliance_client WHERE branch='$veh1'";
...
$query="SELECT veh_no,COUNT(veh_no) AS tagveh_no FROM reliance_client WHERE branch='$veh1' GROUP BY branch";
...
//$query2="SELECT sum(amt) as total FROM sim_no WHERE reliance_sim in (".substr($simlist,0,-1).")";
