...
if(isset($_POST["submit"]))
{
	...
	for($n=0;$n<$monthNo;$n++)
	{
		...
		if($_POST["device"][$n] != "" || $_POST["rent"][$n] != "" || $_POST["accessory"][$n] !="")
		{
			...
			{
				$update_pending = array('device_amount_pending' => $_POST["device"][$n], 'rent_amount_pending' => $_POST["rent"][$n], 
			'accessory_amount_pending' => $_POST["accessory"][$n], 'req_time' =>  date("Y-m-d H:i:s"));
			...
			else
			{
				...
				$debtor_history = array('client_id' => $client_name, 'company_name' => $company_name, 'sales_manager' => $sales_manager, 
					...
					'device_amount_pending' =>  $_POST["device"][$n], 'rent_amount_pending' =>  $_POST["rent"][$n], 
					'accessory_amount_pending' =>  $_POST["accessory"][$n], 'req_time' =>  date("Y-m-d H:i:s"));
