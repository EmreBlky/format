...
if($_POST["Showrequest"]==1)
 ...
 { 
	 ...
	 $WhereQuery=" where ((approve_status=0 and final_status!=1 and pay_pending is null and account_comment is null ) or (forward_req_user='".$_SESSION["user_name"]."' and (forward_back_comment is null or forward_back_comment='')))";
...
?>
	...
	$rowuser=select_query($sql);
        ...
        <td style="230px"><a href="#" onclick="Show_record(<?php echo $query[$i]["id"];?>,'reactivation_of_account','popup1'); " class="topopup">View Detail</a>
