...
?>
      ...
      <!--<tr align="center" <? //if($query[$i]["account_comment"]=='Payment cleared'){ echo 'style="background-color:#99FF66"';}elseif($query[$i]["payment_status"]!='' && $query[$i]["service_comment"]==''){ echo 'style="background-color:#FF0000"';}?> >-->
      <tr align="center" <? if($query[$i]["final_status"]==1){ echo 'style="background-color:#99FF66"';}elseif($query[$i]["approve_status"]==1 && $query[$i]["final_status"]!=1){ echo 'style="background-color:#B6B6B4"';}elseif($query[$i]["admin_comment"]!='' && $query[$i]["approve_status"]==0){ echo 'style="background-color:#FF0000"';}?> >
        <td><?php echo $i+1;?></td>
