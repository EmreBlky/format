...
$query = select_query("SELECT * FROM new_account_creation where final_status=1 or (forward_req_user='".$_SESSION["user_name"]."' and (forward_back_comment is null or forward_back_comment='')) order by id DESC ");
