...
if($_POST["Showrequest"]==1)
 ...
 { 
	 ...
	 $WhereQuery=" where ((approve_status=1 or account_comment!='') and repair_comment IS NULL) or (forward_req_user='".$_SESSION["user_name"]."' and (forward_back_comment is null or forward_back_comment=''))";
