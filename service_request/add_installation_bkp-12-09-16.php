   ...
   /* if($_SESSION['BranchId']==1 && $branch_type == "Samebranch" && $instal_reinstall == "installation")
    ...
    if($errorMsg=="")   
    {
        if($atime_status=="Till")
        {
			  ...
			  rent_status, rent_month, rent_payment) VALUES('".$date."','".$account_manager."','".$sales_person."', '".$main_user_id."', 
			  ...
			  '".$rent_status."','".$rent_month."','".$rent_payment."')";
            ...
            if($installation_status == 1)
            {
                for($N=1;$N<=$no_of_vehicals;$N++)
                {
					...
					device_rent_service_tax, DTotalREnt, demo_time, rent_status, rent_month, rent_payment) VALUES('".$insert_id."','".$date."',
					...
					'".$TxtDTotalREnt."','".$demo_time."','".$rent_status."','".$rent_month."','".$rent_payment."')";
        ...
        if($atime_status=="Between")
        {
            ...
            $totime=$_POST['totime'];
			 ...
			 rent_payment) VALUES('".$date."','".$account_manager."','".$sales_person."', '".$main_user_id."', '".$company."',
...
function req_info()
{
 ...
 if(document.form1.Zone_area.value=="")
  ...
  return false;
	...
	if(document.form1.mode_of_payment.value=="")
 	{
		alert("Please Choose Mode") ;
		document.form1.mode_of_payment.focus();
		return false;
    }
	
	if(document.form1.mode_of_payment.value=="Cash")
    {
    ...
    if(document.form1.mode_of_payment.value=="Cheque")
    {
    ...
    if(document.form1.mode_of_payment.value=="Demo")
    {
        if(document.form1.TxtDemo.value=="")
        {
            alert("Please Enter Demo") ;
            document.form1.TxtDemo.focus();
            return false;
        }
    }
   
    if(document.form1.mode_of_payment.value=="Lease")
    {
      if(document.form1.TxtDAmount.value=="")
      {
          alert("Please Enter Amount") ;
          document.form1.TxtDAmount.focus();
          return false;
      }
    }
	
	if(document.form1.mode_of_payment.value=="Crack")
    {
      if(document.form1.TxtDPricecash.value=="")
      {
          alert("Please Enter Device Price") ;
...
function set_Price()
{
	    var pricechange = document.getElementById('price_diff').checked;
		...
		else
		{
			...
			document.getElementById('CrackCase').style.display = "none";
		}
}
...
function PaymentProcessBYCash(radioValue)
{
    ...
    {
        document.getElementById('CrackCase').style.display = "block";
		document.getElementById('ChequeCase').style.display = "none";
        document.getElementById('CashCase').style.display = "none";
        document.getElementById('DemoCase').style.display = "none";
        document.getElementById('LeaseCase').style.display = "none";
    ...
    <table style="padding-left: 100px;width: 500px;" cellspacing="5" cellpadding="5">
      ...
      <tr>
        ...
        <td><select name="main_user_id" id="main_user_id"  onchange="showUser(this.value,'ajaxdata'); getCompanyName(this.value,'TxtCompany');
         getClientPrice(this.value,'mode_of_payment','device_price_client','rent_client');">
      ...
      <tr id="showrslt" style="width: 100%;display:none;">
        <td height="32" align="right">Account Details:</td>
          <td><div id="mode_of_payment"><input type="hidden" name="ModePay" id="ModePay" value="" /></div>
          <div id="device_price_client"><input type="hidden" name="AccPrice" id="AccPrice" value="" /></div>
          <div id="rent_client"></div><input type="hidden" name="AccRent" id="AccRent" value="" /></td>
      </tr>
      <tr>
        <td colspan="2" align="left"><!-- CheckBox request-->         
          <table id="price_check"  style="width: 100%;display:none; margin-left:10px;">
            <tr>
                ...
                <td style="margin-left:20px;"><input type="checkbox" name="price_diff" id="price_diff" value="yes" onclick="set_Price()"  /></td>
            </tr>
          </table>
        </td>
      </tr>
      <tr>
       <td colspan="2" align="center"><!-- Mode request -->
            <table  id="modepayment" style="width:100%;display:none;border:1"  cellspacing="5" cellpadding="0">
              <tr>
                <td height="32" align="right">Mode Of Payment</td>
                <td><select name="mode_of_payment" id="mode_of_payment" onchange="PaymentProcessBYCash(this.value)" style="width:150px">
                    ...
                    <option value="Crack" <? if($result[0]['mode_of_payment']=='Crack') {?> selected="selected" <? } ?>> Crack</option>
                  </select></td>
              </tr>
      	   </table>
         </td>
      ...
      <tr>
        <td colspan="2" align="center"><!-- cash request -->
            ...
            <tr>
              <td height="32" align="right"><label for="rent_month" id="rent_month">Rent Month</label></td>
      ...
      <tr>
        <td colspan="2" align="center"> <!--Demo request -->
        	<table  id="DemoCase"    style="width:100%;display:none;border:1"  cellspacing="5" cellpadding="5">
            <tr>
              <td height="32" align="right"><label for="demo" id="demo">Demo</label></td>
              <td><select name="Demo_time" id="TxtDemo" >
                  <option value="" name="Demo_time" id="Demo_time">-- Select One --</option>
      ...
      <tr>
        <td colspan="2" align="center"> <!-- Lease request-->
        	<table  id="LeaseCase"    style="width:100%;display:none;border:1"  cellspacing="5" cellpadding="5">
            <tr>
              <td height="32" align="right"><label for="price" id="lblDprice">Amount</label></td>
              <td><input type="value" name="device_amount_total" id="TxtDAmount" value="<?=$result[0]['device_price_total']?>"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'  /></td>
            </tr>
            <tr>
              <td height="32" align="right"><label for="rent_status" id="rent_status"> Rent status </label></td>
              <td ><Input type = 'Radio' Name ='rent_status' id="rent_status" value= 'Excluding'
      ...
      <tr>
        <td colspan="2" align="center"><!-- Crack request -->
        	<table  id="CrackCase" style="width:100%;display:none;border:1"  cellspacing="5" cellpadding="0">
            <tr>
              <td height="32" align="right"><label for="price" id="lblDprice">Device Price</label></td>
