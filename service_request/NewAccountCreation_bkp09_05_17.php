    ...
    <table style=" padding-left: 100px;width: 500px;" cellspacing="5" cellpadding="5">
      ...
      <tr>
        ...
        <td><select name="mode_of_payment" id="mode_of_payment" onchange="PaymentProcessBYCash(this.value)" style="width:150px">
            ...
            <option value="Trip Based" <? if($result[0]['mode_of_payment']=='Trip Based') {?> selected="selected" <? } ?>> Trip Based</option>
          </select></td>
      </tr>
      <tr>
        <td colspan="2"><!-- Cheque request-->
          
          <table  id="ChequeCase"  style="width: 500px;display:none;border:1" cellspacing="5" cellpadding="0">
            <tr>
            ...
            <tr>
              <td width="128"><label for="rent_month" id="rent_month">Rent Month</label></td>
              <td width="355"><select name="rent_month1" id="rent_month1" >
      ...
      <tr>
        <td colspan="2"><table  id="CashCase"    style="width: 500px;display:none;border:1"  cellspacing="5" cellpadding="0">
            <tr>
              <td><label for="price" id="lblDprice">Device Price</label></td>
            ...
            <tr>
              <td><label for="rent" id="lblDRent">Rent</label></td>
              <td><input type="value" name="TxtDTotalREnt1" id="TxtDRentCash" value="<?=$result[0]['DTotalREnt']?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' /></td>
            </tr>
            <tr>
              <td><label for="rent_status" id="rent_status"> Rent status </label></td>
              <td><Input type = 'Radio' Name ='rent_status' id="rent_status" value= 'Excluding'
            ...
            <tr>
              <td width="128"><label for="rent_month" id="rent_month">Rent Month</label></td>
              <td width="355"><select name="rent_month" id="rent_month" >
      ...
      <tr>
        <td colspan="2"><table  id="DemoCase"    style="width: 500px;display:none;border:1"  cellspacing="5" cellpadding="5">
            <tr>
              <td width="128px"><label for="demo" id="demo">Demo</label></td>
              <td width="355px"><select name="Demo" id="TxtDemo" >
      ...
      <tr>
        <td colspan="2"><table  id="LeaseCase"    style="width: 500px;display:none;border:1"  cellspacing="5" cellpadding="5">
            <tr>
              <td><label for="price" id="lblDprice">Amount</label></td>
            ...
            <tr>
              <td width="128px"><label for="rent_status" id="rent_status"> Rent status </label></td>
              <td width="355px"><Input type = 'Radio' Name ='rent_status' id="rent_status" value= 'Excluding'
                    <?php if($result[0]['rent_status']=="Excluding"){echo "checked=\"checked\""; }?>/>
                Excluding
                <Input type = 'Radio' Name ='rent_status' value= 'Including'
                    <?php if($result[0]['rent_status']=="Including"){echo "checked=\"checked\""; }?>/>
      ...
      <tr>
        <td colspan="2"><table id="DimtsCase"  style="width: 300px;display:none;border:1" cellspacing="5" cellpadding="0">
            <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="user_name" id="TxtUserName" value="<?=$result[0]['user_name']?>"/></td>
      </tr>
      <tr>
...
<script>PaymentProcessBYCash12("<?=$result[0]['mode_of_payment'];?>");</script>
<?php
