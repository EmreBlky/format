      ...
      <tr>
        ...
        <td>
          <table>
            <tr>
              <td>
                <select name="no_of_installation" id="textB" style="width:150px"><option>-Select No. IMEI-</option></select>
              </td>
              <td>
                <select name="status" id="status" style="width:150px;display:none">
