...
//									$time=$time+19800;
	...
	$fp=fopen($path,'r');
	 ...
	 if(isset($_POST['submit']))
		...
		$data=select_query_live("select id,sys_simcard from devices where imei='".$_POST['TxtImei']."'");
            $service_data=select_query_live('select id,log,veh_reg from services where sys_device_id =('.$data[0]['id'].')');
		 ...
		 switch($strlength)
		 {
		  ...
		  //pointer code
			...
			<div style="font-weight:bold;font-size:14px">
				...
				<span class="style3"><?  $sys_user_name;?></span>
				<br/><br/>
