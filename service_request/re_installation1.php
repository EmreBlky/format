      ...
      $.ajax({
        ...
        success:function(msg){
         ...
         for(var i =1; i <= number; i++){
            ...
            var age1 = `<tr><td><select name='imei[]' onchange="devicestatus(this.value,'txtDeviceStatus${i}')">${option}</select></td><td><input type='text' name='txtDeviceStatus' id='txtDeviceStatus${i}'></td></tr>`;
 ...
 <form method="post" action="" name="form1" onSubmit="return req_info();">
    <table style="padding-left: 100px;width: 600px;" cellspacing="5" cellpadding="5">
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="company" id="TxtSalesPersonName" readonly /></td>
      </tr>
      <tr>
        <td  align="right">Company Name:</td>
        <td colspan="2"><input type="text" name="company" id="TxtCompany" readonly /></td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <table>
            <tr>
              <td>
                <select id="textB"><option>-Select No. IMEI-</option></select>
              </td>
              <td>
