...
if(isset($_GET['action']) && $_GET['action']=='modelType')
{	
	$sql="SELECT device_model as modelName FROM new_account_model_master WHERE device_type='".$q."' LIMIT 1";
...
{
	$sql1="SELECT id FROM addclient WHERE Userid=".$q;

	$row1=select_query($sql1);

	$sql2="SELECT device_type as deviceId,name as deviceType,device_model as modelName FROM new_account_model_master newmodel LEFT JOIN device_types dtype ON newmodel.device_type=dtype.id WHERE new_account_reqid=".$row1[0]["id"];
  ...
  <div class="dataleft">
    ...
    ?>
      ...
      <tr>
        ...
        <td><?echo $row[0]["billing_amount"];?></td>
      </tr>
      <tr>
...
<div >
  ...
  <div class="table">
    <table cellspacing="2" cellpadding="2" style=" padding-left: 100px;width: 500px;">
      ...
      <? $sql="select * FROM internalsoftware.gtrac_branch where id=".$row[0]["branch_id"];
    $rowuser=select_query($sql);
    ?>
      <tr>
        <td>Branch Name</td>
