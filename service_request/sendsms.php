...
$query="SELECT inst_id,inst_name FROM installer where branch_id=".$_SESSION['BranchId'];
$result=mysql_query($query);

?> 
 <select name="inst_name" id="inst_name"  onchange="getInstallermobile(this.value,'Number');"><option value="0">Select Name</option>
