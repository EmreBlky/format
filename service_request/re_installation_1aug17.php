      ...
      jq.ajax({
        ...
        success:function(msg){
         ...
         for(var i =1; i <= number; i++){
            ...
            var age1 = `<tr><td><select name='imei[]' style="width:150px" onchange="devicestatus(this.value,'txtDeviceStatus${i}'),devicetype(this.value,'txtDeviceType${i}'),devicemodel(this.value,'txtDeviceModel${i}')">${option}</select></td><td><input type='text' style="width:145px" placeholder="Device Status" name='txtDeviceStatus[]' id='txtDeviceStatus${i}'></td><td><input type='text' style="width:145px" name='txtDeviceType[]' placeholder="Device Type" id='txtDeviceType${i}'></td><td><input type='text' style="width:145px" name='txtDeviceModel[]' placeholder="Device Model" id='txtDeviceModel${i}'></td></tr>`;
...
{ 
    ...
    { 
      if($atime_status=="Till")
      {
              ...
              $sql="INSERT INTO installation_request(`req_date`, `request_by`, sales_person, `user_id`, `company_name`, no_of_vehicals, device_status, location,model,time, contact_number, status, contact_person, veh_type,required,branch_id,installation_status, Zone_area,atime_status,`inter_branch`, branch_type, instal_reinstall,designation,device_type,alter_contact_no,accessories_tollkit,billing,TrailerType,TruckType,MachineType,actype,standard,alt_cont_person,alt_designation,acess_selection,luxury) VALUES('".$date."','".$account_manager."','".$sales_person_id."', '".$main_user_id."', '".$company."','".$no_of_vehicals."','".$status."','".$branchLocation."','".$model."', '".$time."', '".$contact_number[0]."',1,'".$contact_person[0]."','".$veh_type."','".$required."',
              '".$_SESSION['BranchId']."','".$installation_status."','".$Area."','".$atime_status."','".$city."','".$branch_type."',
              '".$instal_reinstall."','".$designation[0]."','".$deviceType."','".$contact_number[1]."','".$accessories_tollkits."','".$billing."','".$TrailerType."','".$TruckType."','".$MachineType."','".$actype."','".$del_nodelux."','".$contact_person[1]."','".$designation[1]."','".$acess_selection."','".$luxury."')";
        ...
        if($atime_status=="Between")
        {
            ...
            //1-New,2-assigned,3-newbacktoservice,4-backtoservice,5-close,6-callingclose
             ...
             required,branch_id, installation_status,Zone_area, atime_status,`inter_branch`, branch_type, instal_reinstall,designation,device_type,alter_contact_no,accessories_tollkit,billing,TrailerType,TruckType,MachineType,actype,standard,alt_cont_person,alt_designation,acess_selection,luxury) VALUES('".$date."','".$account_manager."','".$sales_person_id."', '".$main_user_id."', '".$company."',
             '".$no_of_vehicals."','".$no_of_vehicals."','".$location."','".$model."','".$time."','".$totime."','".$contact_number[0]."',now(),1,'".$contact_person[0]."','".$veh_type."','".$required."',
             '".$_SESSION['BranchId']."','".$installation_status."','".$Area."','".$atime_status."','".$city."','".$branch_type."',
             '".$instal_reinstall."','".$designation[0]."','".$deviceType."','".$contact_number[1]."','".$accessories_tollkits."','".$billing."','".$TrailerType."','".$TruckType."','".$MachineType."','".$actype."','".$del_nodelux."','".$contact_person[1]."','".$designation[1]."','".$acess_selection."','".$luxury."')";
                  ...
                  if($installation_status == 1)
                  {
                      ...
                      for($N=0;$N<$no_of_vehicals;$N++)  
                      {
                          $installation = "INSERT INTO installation(`inst_req_id`, `req_date`, `request_by`,sales_person,`user_id`, `company_name`,no_of_vehicals,location,model,time, totime,contact_number,installed_date, status, contact_person, veh_type,required,branch_id,installation_status, Zone_area,atime_status,`inter_branch`,
                           branch_type, instal_reinstall,designation,device_type,alter_contact_no,accessories_tollkit,billing,TrailerType,TruckType,MachineType,actype,standard,alt_cont_person,alt_designation,acess_selection,device_imei,device_status,imei_status) VALUES('".$insert_id."','".$date."',
                           ...
                           '".$installation_status."','".$Area."','".$atime_status."','".$city."','".$branch_type."','".$instal_reinstall."','".$designation."','".$deviceType."','".$alt_cont_number."','".$accessories_tollkits."','".$billing."','".$TrailerType."','".$TruckType."','".$MachineType."','".$actype."','".$del_nodelux."','".$alt_cont_person."','".$alt_designation."','".$acess_selection."','".$imei[$N]."','".$status."','".$deviceStatus[$N]."'
                           )";
...
/*td{ border :1px solid#000; }*/
 ...
 <form method="post" action="" name="form1" onSubmit="return req_info();">
    <table style="padding-left: 100px;width: 600px;" cellspacing="5" cellpadding="5">
      <tr>
        <td align="right" nowrap width="100px"> Client User Name:* </td>
        <td width="400px">
      ...
      <tr>
        ...
        <td align="right" nowrap >Select Device Type</td>
        <td>
      ...
      <tr>
        <td align="right" nowrap>No. Of Installation:*</td>
        <td>
    ...
    <tr>
      ...
      <td>
        ...
        <tr>
          <td>
            <select name="accessories[]" multiple id="accessories" height="1" style="max-width:15px;margin-right:20px;" >
