    ...
    <table style="padding-left: 100px;width: 500px;" cellspacing="5" cellpadding="5">
      <tr>
       ...
       <tr>
        ...
        <td width="54%"><input type="checkbox" name="required" id="required" value="urgent" <?php if($result[0]['required']=='urgent') {?> checked="checked" <?php }?> />
        </td>
      </tr>
      <tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td><?php echo $result[0]['no_of_vehicals']?></td>
      </tr>
