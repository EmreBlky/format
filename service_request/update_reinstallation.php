...
ur("#delRowss").click(function(){
      ur("#dataDesignation").hide();
      ur("#designation2").val('');
      ur("#contact_person2").val('');
      ur("#contact_number2").val('');

  });
  ur("#addRowss").click(function(){
      ur("#dataDesignation").show();
  });    
  ...
  $('#datetimepicker2').datetimepicker({
    ...
    ur("#Zone_area").keyup(function(event){
         ...
         var city_id= ur("#inter_branch_loc").val();
         var inter_branch= ur("#inter_branch").val();
         //alert(city_id);
         if(city_id=='')
         {
            city_id=1;
         ...
         if(keyword.length)
         {
             ...
             else
             {
                switch (event.keyCode)
                {
                 ...
                 case 13:
                    ur("#ajax_response").fadeOut("slow");
                    ur("#Zone_area").val(ur("li[class='selected'] a").text());
                 break;
                }
             }
         }
...
{ 
  ...
  var imeiNumber = document.getElementsByName("deviceimeiupdate[]");
  var ret = true;
  ...
  var acc_len = ur('[name="accessories[]"]:checked').length;
    ...
    <tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td><input type="text" readonly value="<?php echo $result[0]['device_status'];?>" /></td>
      </tr>
      <tr>
              ...
              for($i=1;$i<=$no_installation;$i++){ ?>
               <tr>
                 <td>
                    ...
                    ?>
                  <select style="width:130px;" name="deviceimeiupdate[]" onchange="deviceStaus(this.value,'status<?= $i-1 ?>');imeiDeviceType(this.value,'deviceTypeUpdate<?= $i-1 ?>');imeiDeviceModel(this.value,'deviceModelUpdate<?= $i-1 ?>')" id="<?= $i-1 ?>">
                      <?php 
                        $isSelected = 0;
    ...
    <tr>
        ...
        <td style="margin-left:20px;">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="contact_number" id="contact_number" placeholder="Contact Number"  minlength="10" maxlength="10" value="<?php echo $result[0]['contact_number']?>" style="width:147px" onkeypress="return event.charCode >= 48 && event.charCode <= 57"/>
            </td>       
          </tr>

           <tr id="dataDesignation" <?php if(strlen($result[0]['alter_contact_no']) > 0) {} else{?>style="display:none"<?php } ?>>
            <td  height="32" align="right">
              <select name="designation2" id="designation2" style="margin-left:-4px" onchange="designationChange(this.value)">
                <option value="" <?php if($result[0]['alt_designation']=='') {?> selected="selected" <?php } ?>disabled>-- Select Designation --</option>
          ...
          <table align="left" cellspacing="" cellpadding="">
            <tr>
              ...
              <td>
                ...
                <select name="actype" id="actype" <?php if(($result[0]['veh_type'])=='Car' || ($result[0]['veh_type'])=='Bus' || ($result[0]['veh_type'])=='Tempo') {?> style="width:150px;" <?php } else { ?> style="width:147px;display:none;" <?php } ?> >
              ...
              <td>
                <select name="MachineType" id="MachineType" palceholder="Machine Type" style="width:150px;display:none" >
