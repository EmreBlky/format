 ...
 <form name="myForm" action="" onsubmit="return validateForm()" method="post">
   ...
   <table style="padding-left:100px;width:500px;" cellspacing="5" cellpadding="5">
        ...
        <tr>
            ...
            <option value="">-- Select One --</option>
            <?php
            $main_user_iddata=select_query("SELECT Userid AS user_id,UserName AS `name` FROM internalsoftware.addclient WHERE 
           ...
           <option name="main_user_id" value="<?=$main_user_iddata[$u]['user_id']?>" <? if($result[0]['user_id']==$main_user_iddata[$u]['user_id']) {?> selected="selected" <? } ?> >
            <?php echo $main_user_iddata[$u]['name']; ?>
            </option>
            <?php 
            } 
        ...
        <tr>
            ...
            <?php
            $device=select_query("SELECT * FROM internalsoftware.device_type");
            //while ($data=mysql_fetch_assoc($main_user_id))
			for($i=0;$i<count($device);$i++)
            {
            ?>
            
            <option value ="<?php echo $device[$i]['device_type'] ?>" <? if($result[0]['device_model']==$device[$i]['device_type']) {?> selected="selected" <? } ?> > 
                <?php echo $device[$i]['device_type']; ?>    
            </option>
            <?php 
            } 
        ...
        <tr><td colspan="2" align="center"> <input type="submit" id="button1" name="submit" value="submit"  />
