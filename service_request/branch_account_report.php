  ...
  <form method="post" action="" name="form1" onSubmit="">
    <table style="padding-left: 100px;width: 500px;" cellspacing="5" cellpadding="5">
      <tr>
        ...
        <td><input type="text" name="date" id="datepicker1" value="<?php echo $date;?>" readonly="readonly"/></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><select name="client_name" id="TxtClient_name" >
            ...
            <?php
                ...
                {
                ?>
            <option name="main_user_id" value="<?=$main_user_iddata[$u]['name']?>" <? if($result[0]['clients']==$main_user_iddata[$u]['name']) {?> selected="selected" <? } ?> > <?php echo $main_user_iddata[$u]['name']; ?> </option>
            <?php 
                } 
      ...
      <tr>
        ...
        <td><input type="text" name="expected_ammount" id="TxtExpectedAmmount"  value="<?php echo $result[0]['expected_ammount'];?>" readonly="readonly"/></td>
      </tr>
      <tr>
