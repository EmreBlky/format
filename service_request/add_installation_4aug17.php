    ...
    <tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td width=""><input type="checkbox" name="required" id="required" value="urgent" <?php if($result['required']=='urgent') {?> checked="checked" <? }?> /></td>
          ...
          for($v=0;$v<count($accessory_data);$v++)
          {
            ?>
                <tr>
                  ...
                  <td><input type="checkbox" name="accessories[]" id="accessories" value="<?php echo $accessory_data[$v]['id']; ?>" style="width:150px;">
     ...
     <tr>
      ...
      <tr>
        <td colspan="2">
          ...
          <table  id="BetweenTime" align="left" style="width:100%;display:none;margin-left:58px;border:1px solid #000;"  cellspacing="5" cellpadding="5">
            <tr>
