...
if(isset($_POST["submit"]))
{
 ...
 if($action=='edit')
    ...
    if($insert_query)
    {
        ...
        $Subject = "Login Forwarded Details";
 ...
 <form name="myForm" action="" onSubmit="return validateForm()" method="post">
    ...
    <table width="589" cellpadding="5" cellspacing="5" style=" padding-left: 100px;width: 550px;">
        ...
        <tr>
            <td colspan="2">
                ...
                <input type="hidden" name="branch_id" value="<?=$_SESSION['BranchId'];?>" />
                 <input type="hidden" name="tech_support_id" value="<?=$_SESSION['support_group_id'];?>" />
             </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="assign_to" id="assign_to" value="<?=$result[0]['assign_to'];?>"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td> <textarea rows="5" cols="25"  type="text" name="reason" id="reason" > <?=$result[0]['reason']?></textarea></td>
        </tr>
