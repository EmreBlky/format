...
<div class="table">
 ...
 {
	 $WhereQuery=" where admin_comment!='' and dimts_status=2";
 }
 ...
 { 
	 $WhereQuery=" where approve_status=0 and (payment_status!='') and (admin_comment is null or service_comment!='') and dimts_status=1 and (forward_req_user is null or forward_back_comment!='')";
