...
<div class="table">
 ...
 {
	 $WhereQuery=" where admin_comment!='' and approve_status=0 and (sales_comment is null or reactivation_status=2)";
 }
 ...
 { 
	 $WhereQuery=" where approve_status=0 and (account_comment!='' or pay_pending!='') and (admin_comment is null or sales_comment!='') and reactivation_status=1 and (forward_req_user is null or forward_back_comment!='') and (service_comment!='' or service_comment is null) ";
