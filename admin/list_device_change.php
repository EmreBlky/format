...
if($_POST["Showrequest"]==1)
 ...
 {
	 $WhereQuery=" where admin_comment!='' and approve_status=0 and (service_comment is null or device_change_status=2)";
 }
 ...
 { 
	 ...
	 $WhereQuery=" where approve_status=0 and (admin_comment is null or (service_comment!='' or service_support_com!='')) and 
	 device_change_status=1 and (account_comment!='' or pay_status!='') 
