...
if($_POST["Showrequest"]==1)
 ...
 {
	 $WhereQuery=" where admin_comment!='' and approve_status=0 and (sales_comment is null or stop_gps_status=2)";
 }
 ...
 { 
	 $WhereQuery=" where approve_status=0 and (account_comment!='' or total_pending!='') and stop_gps_status=1 and (admin_comment is null or sales_comment!='') and (forward_req_user is null or forward_back_comment!='')";
