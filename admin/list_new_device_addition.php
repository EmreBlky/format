...
<div class="table">
 ...
 {
		$WhereQuery=" where admin_comment!='' and final_status=0 and (service_comment is null or new_device_status=2)"; 
 }*/
 else if($_POST["Showrequest"]==2)
 {
 ...
 { 
	 ...
	 $WhereQuery=" where final_status=1 and (forward_req_user is null or forward_back_comment!='')";
