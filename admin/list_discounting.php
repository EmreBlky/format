...
$.ajax({
		type:"GET",
		url:"userInfo.php?action=discount_detailsapprove",
 		data:"row_id="+row_id,
...
$.ajax({
		type:"GET",
		url:"userInfo.php?action=discount_detailsadminComment",
...
if($_POST["Showrequest"]==1)
 ...
 {
	 $WhereQuery=" where  admin_comment!='' or forward_comment!=''  and approve_status=0 and (sales_comment is null or discount_status=2)";
 }
 ...
 { 	  
	  $WhereQuery=" where approve_status=0  and (account_comment!='' or total_pending!='') and (admin_comment is null or sales_comment!='') and discount_status=1 and (forward_req_user is null or forward_back_comment!='')";
	  
	 /* $WhereQuery=" where approve_status=0  and (account_comment!='' or total_pending!='' or service_comment!='' or repair_comment!='' or software_comment!='') and (admin_comment is null or sales_comment!='') and discount_status=1 and (forward_req_user is null or forward_back_comment!='')";*/
...
?>
  ...
  ?>
        ...
        <td bgcolor="#EEA095"><?php echo $query[$i]["dis_amt"];?></td>
