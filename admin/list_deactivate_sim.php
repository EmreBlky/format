...
if($_POST["Showrequest"]==1)
 ...
 {
	 $WhereQuery=" where admin_comment!='' and final_status!=1 and service_comment is null";
 }
 ...
 { 
   ...
   /*$WhereQuery=" where (approve_status=0 or approve_status=2) and (admin_comment is null or service_comment!='') and (forward_req_user is null or forward_back_comment!='')";*/
