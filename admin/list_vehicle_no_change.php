...
if($_POST["Showrequest"]==1)
 {
	  $WhereQuery=" where (approve_status=1 or approve_status!=1) and final_status=1";
 }
 ...
 {
	 $WhereQuery=" where admin_comment!='' and approve_status=0 and (service_comment is null or vehicle_status=2)";
 }
 ...
 { 
	 $WhereQuery=" where  approve_status=0 and (admin_comment is null or service_comment!='') and vehicle_status=1 and (account_comment!='' or payment_status!='') and (forward_req_user is null or forward_back_comment!='')";
