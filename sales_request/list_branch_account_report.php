...
if(isset($_POST['submit']))
{
	...
	$query = select_query("SELECT * FROM branch_account_report where request_by='".$user."' and request_date>='".$date_from."' and request_date<='".$date_to."' order by id DESC ");
	
	$excel_count = count($query);
}
else{
 $query = select_query("SELECT * FROM branch_account_report where request_by='".$user."' order by id DESC ");
} 
?>
...
<div class="top-bar"> <a href="payment_report.php" class="button">ADD NEW </a>
