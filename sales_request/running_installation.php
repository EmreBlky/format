...
<div class="table">
  <?php
    ...
    $query = select_query("SELECT * FROM installation where installation_status IN ('1','2','11') AND (inter_branch='".$_SESSION['BranchId']."' OR branch_id='".$_SESSION['BranchId']."') and sales_person='".$sales[0]['id']."' order by id desc");
