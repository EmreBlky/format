...
if(isset($_POST["submit"]))
{
	...
	if($tot_no_of_vehicles != 0 && $selected_radio == "Permanent")
	{
		$errorMsg = "Kindly First Delete All Vehicle in this Account.";
	}
	else
	{
		$errorMsg = "";
...
function validateForm()
{
   ...
   var deviceremove=document.forms["myForm"]["deviceremove"].value;
   if (deviceremove==null || deviceremove=="")
	  {
		alert("Please Select Device Removed.") ;
		return false;
	  }
   var no_of_removed_devices=document.forms["myForm"]["no_of_removed_devices"].value;
   if (deviceremove == 'Y' && (no_of_removed_devices==null || no_of_removed_devices==""))
	  {
		alert("Please Select No of Removed Device.") ;
		return false;
	  }
   var deactivateStatus=document.forms["myForm"]["deactivateStatus"].value;
   if (deactivateStatus==null || deactivateStatus=="")
	  {
		alert("Please Select Deactivate Status.") ;
		return false;
	  }
...
function Statuschange12(radioValue1)
{
 //alert(radioValue);
 if(radioValue1=="Y")
	{
...
<select name="main_user_id" id="TxtMainUserId"  onchange="gettotal_veh_byuser(this.value,'TxtTotalVehicle');getCompanyName(this.value,'TxtCompany');">
        ...
        <tr>
            ...
            <td>
             ...
             <Input type = 'Radio' Name ='deviceremove' id="deviceremove"   value= 'Y' <?php if($result[0]['device_remove_status']=="Y"){echo "checked=\"checked\""; }?> onchange="Statuschange(this.value)">Yes
            
            <Input type = 'Radio' Name ='deviceremove' id="deviceremove"   value= 'N' <?php if($result[0]['device_remove_status']=="N"){echo "checked=\"checked\""; }?> onchange="Statuschange(this.value)" >No</td>
        </tr>
        <tr>
        	<td colspan="2">
        ...
        <tr>
            ...
            <td>
             ...
             <Input type = 'Radio' Name ='deactivateStatus' id="deactivateStatus"  value= 'temporary' <?php if($result[0]['deactivate_temp']=="temporary"){echo "checked=\"checked\""; }?>
            onchange="Status(this.value)"
            >Temporary
            
            <Input type = 'Radio' Name ='deactivateStatus' id="deactivateStatus"    value= 'Permanent' <?php if($result[0]['deactivate_temp']=="Permanent"){echo "checked=\"checked\""; }?>
            onchange="Status(this.value)"
            >Permanent</td>
        </tr>
        ...
        <tr>
        	<td colspan="2">
			  <table  id="temporarysat"  align="center"  style="padding-left: 90px;width: 300px;display:none;border:1" cellspacing="5" cellpadding="5">
                <tr>       
                ...
                <table  id="Permanentsat" align="center"   style="padding-left: 140px;width: 300px;display:none;border:1" cellspacing="5" cellpadding="5">
                    <tr>       
                        <td colspan="2">
        ...
        <tr>
            ...
            <td class="submit" colspan="2"><input type="submit" id="button1" name="submit" value="Submit" onclick="return Check();"/>
...
<script>Statuschange12("<?=$result[0]['device_remove_status'];?>");Status12("<?=$result[0]['deactivate_temp'];?>");</script> 
