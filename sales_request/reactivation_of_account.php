...
if($action=='edit' or $action=='editp')
	{
		$result = select_query("select * from reactivation_of_account where id=$id");	
	}
?>
...
function validateForm()
{
  ...
  ?>
      ...
      <tr>
        ...
        <td><Input type = 'Radio' Name ='reactivate_account' value= 'Y' <?php if($result[0]['reactivate_account_status']=="Y"){echo "checked=\"checked\""; }?> >
          Yes
          <Input type = 'Radio' Name ='reactivate_account' value= 'N' <?php if($result[0]['reactivate_account_status']=="N"){echo "checked=\"checked\""; }?> >
          No</td>
      </tr>
    </table>
    <table style=" padding-left: 100px;width: 500px;" cellspacing="5" cellpadding="5">
