...
if(isset($_POST["submit"]))
{
	...
	if($month=="") {
	$DiscountMth=$result[0]['mon_of_dis_in_case_of_rent'];
	}
	else {
	$DiscountMth = $month;
	}
...
<select name="main_user_id" id="TxtMainUserId"  onchange="showUser(this.value,'ajaxdata');gettotal_veh_byuser(this.value,'TxtTotalVehicle');getCompanyName(this.value,'TxtCompany');">
           ...
           <option name="main_user_id" value="<?=$main_user_id[$u]['user_id']?>" <? if($result[0]['user']==$main_user_id[$u]['user_id']) {?> selected="selected" <? } ?> >
 ...
 <tr>
            ...
            <td><input type="text" name="tot_no_of_vehicles" id="TxtTotalVehicle" value="<?=$result[0]['total_no_of_vehicles']?>" />            
            	<input type="hidden" name="no_veh" id="Txtno_veh" value="<?=$result[0]['no_of_vehicle']?>" />
            </td>
        </tr>
       <tr>
<td>
...
<div id="ajaxdata"><?=$result[0]['reg_no']?></div> 
        ...
        <td>
            <input type="radio" name="discountFor" id="rent_id" value="Rent" onchange="RentDeviceDiv(this.value)" <?php if($result[0]['rent_device']=="Rent"){echo "checked=\"checked\""; }?>/>Rent 
            <input type="radio" name="discountFor" id="device_id" value="Device" onchange="RentDeviceDiv(this.value)" <?php if($result[0]['rent_device']=="Device"){echo "checked=\"checked\""; }?>/>Device
            <input type="radio" name="discountFor" id="repair_cost_id" value="Repair Cost" onchange="RentDeviceDiv(this.value)" <?php if($result[0]['rent_device']=="Repair Cost"){echo "checked=\"checked\""; }?>/>Repair Cost
        </td>
        <!--<td>
        <input type="checkbox" name="discountFor" value="Rent" id="rent_id" onchange="RentDeviceDiv(this.value)"  <?php if($result[0]['rent_device']=="Rent"){echo "checked=\"checked\""; }?>>Rent<br>
<input type="checkbox" name="discountFor" value="Device" id="device_id" onchange="RentDeviceDiv(this.value)"  <?php if($result[0]['rent_device']=="Device"){echo "checked=\"checked\""; }?>>Device
<br>
<input type="checkbox" name="discountFor" value="Repair Cost" id="repair_cost_id" onchange="RentDeviceDiv(this.value)"  <?php if($result[0]['rent_device']=="Repair Cost"){echo "checked=\"checked\""; }?>>Repair Cost </td>-->
        </tr>
   </table>
   
  <div id="sub1" style="display:none" align="center">
<table width="550" border="0" align="center">
 ...
 <div id="sub2" style="display:none" align="center">
...
<tr>
            ...
            <td>
              <div align="left">
                <input type="text" name="before_discount_rent" id="before_discount_rent" value="<?=$result[0]['amt_before_dis']?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
               </div></td>
        </tr>
<tr>
    ...
    <td width="50%">
      <div align="left">
        <input type="text" name="discount_Amount_rent" id="discount_amount_rent" value="<?=$result[0]['dis_amt']?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' autocomplete="off" onblur="calculatediscount(this.value);"/>
    </div></td>
  </tr>
           ...
           <tr>
            ...
            <td>
              <div align="left">
                <input type="text" name="after_discount_rent" id="after_discount_rent" value="<?=$result[0]['amt_rec_after_dis']?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57'  />
               </div></td>
        </tr>
...
<div id="sub4" style="display:none" align="center">
...
<table width="36%" border="0" cellpadding="0" cellspacing="" align="center">
    ...
    <td width="50%">
      <div align="left">
        <input type="text" name="discount_repair_cost" id="discount_repair_cost" value="<?=$result[0]['dis_amt']?>"/>
    </div></td>
  </tr>
   ...
   <div id="sub3" style="display:none" align="center">
<table width="36%" border="0" cellpadding="0" cellspacing="" align="center">
<tr>
            <td class="style2">
                Amount before discount
</td>
            <td><input type="text" name="before_discount_device" id="before_discount_device" value="<?=$result[0]['amt_before_dis']?>"  onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
             </td>
        </tr>
<tr>
            <td width="50%" class="style2">
                Discounted Amount</td>
            <td width="50%"><input type="text" name="discount_Amount_device" id="Discount_Amount_device" value="<?=$result[0]['dis_amt']?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' autocomplete="off" onblur="calculatediscount1(this.value);"/>
    </td>
  </tr>
           ...
           <tr>
            ...
            <td><input type="text" name="after_discount_device" id="after_discount_device" value="<?=$result[0]['amt_rec_after_dis']?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' />
             </td>
        </tr>
       ...
       Issue for Discounting</td><td>
		<select name="discount_issue" id="discount_issue" >
            ...
            <option value="Account Issue" <? if($result[0]['discount_issue']=='Account Issue') {?> selected="selected" <? } ?> >Account Issue</option>
        ...
        <tr>
            <td width="232" class="style3">
                Reason</td>
            <td width="231">
			 <textarea rows="5" cols="25"  type="text" name="TxtReason" id="TxtReason" ><?=$result[0]['reason']?></textarea>
