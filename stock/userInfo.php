...
if(isset($_GET['action']) && $_GET['action']=='stockImeiAssign')
{
	$UpdateStockImeiAssign="update installation set installation_status='3' where id=".$row_id;
	mysql_query($UpdateStockImeiAssign);
}
