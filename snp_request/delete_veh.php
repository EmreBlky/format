...
if($action=='edit' or $action=='editp')
    {
    $result = select_query("select * from deletion where id=$id");   
    }
?>
...
if(isset($_POST["submit"]))
{
    ...
    if($device_status == "Sold Vehicle" || $device_status == "Vehicle Stand For Long Time" || $device_status == "Stop GPS" || $device_status == "Device Lost" || $device_status == "Device Dead" || $device_status == "Buy Back" )
    {
...
function DeviceCase(deviceValue)
{
    ...
    if(deviceValue=="Sold Vehicle" || deviceValue=="Vehicle Stand For Long Time" || deviceValue=="Stop GPS" || deviceValue=="Device Lost" || deviceValue=="Device Dead" || deviceValue=="Buy Back")
    {
  ...
  <form name="myForm" action="" onsubmit="return validateForm()" method="post">
    <table style="padding-left:100px;width:500px;" cellspacing="5" cellpadding="5">
      ...
      <tr>
        ...
        <td><input type="text" name="TxtDeviceIMEI" id="TxtDeviceIMEI" value="<?=$result[0]['imei']?>" readonly/></td>
      </tr>
      <tr>
        <td><label for="DeviceIMEI"  id="lblDeviceImie">Device Mobile Number</label></td>
        <td><input type="text" name="Devicemobile" id="Devicemobile" value="<?=$result[0]['device_sim_no']?>" readonly/></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><label  id="lbDlDate">Device Status</label></td>
        <td><select name="device_status" id="device_status" onchange="DeviceCase(this.value)">
            ...
            <option value="Vehicle Stand For Long Time"<? if($result[0]['device_status']=="Vehicle Stand For Long Time"){?> selected="selected" <? }?>> Vehicle Stand For Long Time</option>
            ...
            <option value="Sold Vehicle With Device"<? if($result[0]['device_status']=="Sold Vehicle With Device"){?> selected="selected" <? }?>> Sold Vehicle With Device</option>
            <option value="Buy Back"<? if($result[0]['device_status']=="Buy Back"){?> selected="selected" <? }?>>Buy Back</option>
            <option value="Other(Device Not In Existence)"<? if($result[0]['device_status']=="Other(Device Not In Existence)"){?> selected="selected" <? }?>> Other(Device Not In Existence)</option>
          </select></td>
      </tr>
      ...
      <tr>
        <td colspan="2"><?php //if($action=='edit') {?>
          ...
          <? //} ?>
          <table  id="gtracpending"    style="padding-left:100px;width: 500px;display:none;"  cellspacing="5" cellpadding="5">
            <tr>
              <td><label  id="lbDlDate">Location</label></td>
          ...
          <table  id="notexists"   style="padding-left:100px;width: 500px;display:none;"  cellspacing="5" cellpadding="5">
            <tr>
              <td><label  id="lbDlDate">Location</label></td>
              <td><select name="Txt_location" id="Txt_location">
                  <option value="">-- Select One --</option>
      ...
      <tr>
        <td><label  id="lblReason">Deactivation of SIM</label></td>
        <td><Input type = 'Radio' Name ='DeactiveSim' id="DeactiveSim" value= 'Yes'<?php if($result[0]['deactivation_of_sim']=="Yes"){echo "checked=\"checked\""; }?>
      ...
      <tr>
        <td><label  id="lbDlDate">Deletion date </label></td>
