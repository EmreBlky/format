...
<div class="table">
 ...
 {
	 $WhereQuery=" where (sales_comment!='' or forward_back_comment!='') and final_status!=1 and (account_manager='".$_SESSION['user_name']."' or forward_req_user='".$_SESSION["user_name"]."')";
 }
 else
 { 
