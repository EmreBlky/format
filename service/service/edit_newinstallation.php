...
if(isset($_POST['submit']))
{
	...
	mysql_query("UPDATE installation SET reason='$reason',rtime='$rtime',close_date=inst_date='".date("Y-m-d")."',newpending='0',newstatus='0' ,billing='$billing',payment='$payment'  WHERE id='$id'");	
...
<tr>
<td height="32" align="right">Device Model:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" name="device_model" readonly="readonly" id="device_model" value="<?php echo $rows['device_model'];?>" /></td>
</tr>
<tr>
