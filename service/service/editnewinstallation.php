...
if(isset($_POST['submit']))
	...
	mysql_query("UPDATE services SET name='$name', veh_reg='$veh_reg', Notwoking='$Notwoking', location='$location', atime='$atime',  cnumber='$cnumber',reason='$reason',time='$time',close_date='".date("Y-m-d")."',inst_date='".date("Y-m-d")."',newpending='0',newstatus='0' ,billing='$billing',payment='$payment' WHERE id='$id'");
...
<tr>
<tr>
<td height="32" align="right">Person Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" name="pname" readonly="readonly" id="pname" value="<?php echo $rows['pname'];?>" /></td>
</tr>
<tr>
...
<tr>
<td height="32" align="right">Installation Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" name="inst_name1" readonly="readonly" id="inst_name1" value="<?php echo $rows['inst_name'];?>" /></td>
</tr>
<tr>
...
<?php
 $query="SELECT * FROM reason where reason_for='service'";
