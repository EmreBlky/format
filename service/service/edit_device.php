...
if($username=='gurmeet')
	...
	{
	$query1=("UPDATE repai_device SET name='".$row['name']."', veh_reg='$veh_reg', model='$model', deviceid='$deviceid', Imei='$Imei',  date='$date',problem='$problem',antina='$antina' WHERE id='$id'");
	}
