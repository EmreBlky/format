...
<tr align="Center">
		...
		<th width="9%" align="center"><font color="#0E2C3C"><b>Device Model</b></font></th>
		...
		<th width="11%" align="center"><font color="#0E2C3C"><b>Collected Amount/PayMode</b></font></th>
	...
	<tr align="Center" <? if($row['required']=='urgent'){ ?>style="background:#F6F" <? }?>>
		...
		<td width="9%" align="center">&nbsp;<?php echo $row['device_model'];?></td>		
