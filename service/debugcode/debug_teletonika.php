...
?>
 ...
 <br>  <table width="463" border="1">
  <tr>
    <td width="126" height="19"><span class="style3">GPS TIME STATUS</span></td>
    <td width="129"><span class="style3">LAT LONG STATUS</span></td>
    <td width="86"><span class="style3">AC STATUS</span></td>
    <td width="94"><span class="style3">GPS STATUS</span></td>
  </tr>
  <tr>
    <td height="22">
