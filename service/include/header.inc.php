...
$row_pending=mysql_fetch_array($sql_pending);?>(<?=$row_pending[0]?>)</a></li>
		 ...
		 <li><a href="closed_installations.php">Closed Installation</a></li>
		 <li><a href="closed_services.php">Closed Services</a></li>
...
<?       break;
	   ...
	   case 'praveen':
         ...
         ?>
			...
			<li><a href="airtelbilling/index.php">Airtel Sim Bill</a></li>
...
<?       break;
	   ...
	   case 'radhika':
		...
		<!-- <li><a   href="newpending.php">Pending Services<? $sql_pending=mysql_query("SELECT COUNT(*) FROM services WHERE newpending='1'");
         ...
         <br/><br/>-->
		  <li ><a class="home"  href="installationlist.php">Installation list</a></li>
		 <li ><a class="home"  href="service_list.php">Service list</a></li>
            <li ><a class="home"  href="service_report.php">Service Report</a></li>
			
         <li ><a class="home"  href="installer_report.php">Installer Report</a></li>
      <li ><a class="home"  href="show_installation.php">Installation</a></li>
      <li><a  class="home" href="show_services.php">Services</a></li>
		...
		<!-- <li><a   href="">Pending Service<? $sql_pending=mysql_query("SELECT COUNT(*) FROM services WHERE pending='1'");
         ...
         <li><img src="new.gif"><a   href="new_installation.php">New Installtion<? $sql_status="SELECT COUNT(*) FROM installation WHERE status='1' and branch_id=1 ";
                                         ...
                                         $row_service=mysql_fetch_array($result_status);?>(<?=$row_service[0]?>)</a></li>
										  ...
										  <li><a class="home" href="installer_inst_report.php">Installerwise Report </a></li>
...
<li><a class="home" href="installations.php">Installation</a></li>
         ...
         <li><a class="home" href="repair_device.php">Repair device</a></li>
		  <li><a class="home" href="repair_done.php">Repaired Device</a></li>
		   <li><a class="home" href="service_done.php">Service Done</a></li>
		    <li><a class="home" href="service_receive.php">Service Receive</a></li>
			<li><a class="home" href="sendmailservicecancellation.php">Service cancel</a></li>
