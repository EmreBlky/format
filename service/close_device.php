...
<tr align="Center">
 ...
 if($row['group2']!='Yes' &&  $row['group2']!='int_repaired'&&  $row['group2']!='Not Repairable') {   } else {  ?>
	<tr align="Center"  >
		...
		<td width="11%" align="center">&nbsp;<?php echo $row['Imei'];?>
		<td width="11%" align="center">&nbsp;<?php echo $row['old_imei'];?>
		<td width="12%" align="center">&nbsp;<?php echo $row['new_sim_no'];?></td>
		<td width="12%" align="center">&nbsp;<?php echo $row['old_sim_no'];?></td>
