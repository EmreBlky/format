...
<table id="MainTable" border="1" cellspacing="0" cellpadding="0" width="1082">
   
  <tr>
   
    <td width="173" valign="middle"><p align="center"><strong>Vehicle No.</strong> </p></td>
    <td width="164" valign="middle"><p align="center"><strong>Date</strong></p></td>
    <td width="125" valign="middle"><p align="center"><strong>Status</strong></p></td>
    <td width="189" valign="middle"><p align="center"><strong>warranty/out of warranty</strong></p></td>
    <td width="141" valign="middle"><p align="center"><strong>spare changed</strong></p></td>
    <td width="129" valign="middle"><p align="center"><strong>spare cost</strong></p></td>
    <td width="126" valign="middle"><p align="center"><strong>remark</strong></p></td>
	<th width="1"></th>
  </tr>
 ...
 <tr id="FirstRow">    
    ...
    <p></p></td>
    <td width="164" valign="middle"><p align="center">
    <input type="text" name="date[]" class="datepicker_recurring_start"/>
     </p></td>
    <p></p>
    <td width="125" valign="middle"><p align="center">
     <textarea cols="10" rows="1" name="status[]" ></textarea>
    </p></td>
    <td width="189" valign="middle"><p align="center">
      <textarea cols="17" rows="1" name="warr[]"></textarea>
    </p></td>
    <td width="141" valign="middle"><p align="center">
      <textarea cols="10" rows="1" name="sparep[]"></textarea>
    </p></td>
    <td width="129" valign="middle"><p align="center">
      <textarea cols="10" rows="1" name="sparec[]"></textarea>
    </p></td>
