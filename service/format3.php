...
?>
	 ...
	 <th width="217" scope="col"><div align="left">No of vehicle:- </div></th>
      <th width="221" scope="col"> <p align="left">
	  <input type="text" name="HowManyRows" id="HowManyRows" style="width:110px;" />
	  </p></th>
	  <th width="137"><div align="justify">
...
<table id="MainTable" border="1" cellspacing="0" cellpadding="0" width="1051">
  ...
  <tr>
    ...
    <td width="177" valign="middle"><p align="center"><strong>Date</strong></p></td>
   <td width="173" nowrap="nowrap" valign="bottom"><p align="center"><strong>Service Date</strong></p></td>
    <td width="123" nowrap="nowrap" valign="bottom"><p align="center"><strong>Availability</strong></p></td>
    <td width="119" nowrap="nowrap" valign="bottom"><p align="center"><strong>AC status</strong></p></td>
    <td width="124" nowrap="nowrap" valign="bottom"><p align="center"><strong>Re-fitting</strong></p></td>
    <td width="139" nowrap="nowrap" valign="bottom"><p align="center"><strong>Reason of service</strong></p></td>
	<th width="4"></th>
  </tr>
 ...
 <tr id="FirstRow">    
    ...
    <p></p></td>
    <td width="177" valign="middle"><p align="center">
    <input type="text" class="datepicker_recurring_start" name="date[]"/>
     </p></td>
    <p></p>
   <td width="173" valign="middle"><p align="center">
    <input type="text" class="datepicker_recurring_service" name="servicedate[]" />
     </p></td>
    <td width="123" valign="middle"><p align="center">
      <textarea name="textarea" cols="10" rows="1" name="avail[]"></textarea>
    </p></td>
    <td width="119" valign="middle"><p align="center">
      <textarea name="textarea" cols="10" rows="1" name="acstatus[]"></textarea>
    </p></td>
    <td width="124" valign="middle"><p align="center">
      <textarea name="textarea" cols="10" rows="1" name="refitting[]"></textarea>
    </p></td>
    <td width="139" valign="middle"><p align="center">
      <textarea name="textarea" cols="10" rows="1" name="reason[]></textarea>
    </p></td>
