...
if(isset($_POST['submit']))
{
	...
	mysql_query("UPDATE installation SET payment_status='$payment_status',amount='$amount',paymode='$paymode',reason='$reason',rtime='$rtime',close_date=inst_date='".date("Y-m-d")."',newpending='0',newstatus='0' ,billing='$billing',payment='$payment'  WHERE id='$id'");	
...
if(isset($_POST['update']))
	...
	$pending=mysql_query("UPDATE installation SET inst_name='$inst_name',inst_cur_location='$inst_cur_location' ,billing='$billing',payment='$payment'  WHERE id='$id'");
...
<tr>
<td height="32" align="right">Device Model:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" name="model" readonly="readonly" id="model" value="<?php echo $rows['model'];?>" /></td>
</tr>
<tr>
...
<td><input type="text" name="inst_name1" id="inst_name1" readonly="readonly" value="<?php echo $rows['inst_name'];?>" /></td>
</tr>
<tr>
...
<input type="submit" name="submit" value="submit" align="right" onClick="return req_info(form3)"/>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="button" name="Cancel" value="Cancel" onClick="window.location = 'new_installation.php' " />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="backservice" value="back to service" align="right" onClick="return req_info1(form3)"/></td>
</tr>
</table>
</form>
</body>
