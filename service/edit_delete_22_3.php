...
if($new_name!="" || $new_veh_reg!="" )
	...
	$query1="UPDATE services SET name='".$row1['name']."', veh_reg='$new_veh_reg', Notwoking='$new_Notwoking', location='$new_location', atime='$new_atime', pname='$new_pname',  cnumber='$new_cnumber', pending='0',move_vehicles=1 ".$setqry." WHERE id='$id'";
...
$query1=("UPDATE services SET name='".$row['name']."', veh_reg='$veh_reg', Notwoking='$Notwoking', location='$location', atime='$atime', pname='$pname',  cnumber='$cnumber', pending='0' ".$setqry." WHERE id='$id'");
		}
mysql_query($query1);
