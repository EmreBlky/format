...
if($username=='gurmeet')
	{
$sql="INSERT INTO device(name,veh_reg,model,deviceid,Imei,sim_status,date,problem,antina,servicelogin_id)VALUES('".$row['name']."','".$veh_reg."','".$model."','".$deviceid."','".$Imei."','".$sim_status."','".$date."','".$problem."','".$antina."',".$userId.")";
	}else
	{
	$sql="INSERT INTO repai_device(name,veh_reg,model,deviceid,Imei,sim_status,date,problem,antina)VALUES('".$row['name']."','".$veh_reg."','".$model."','".$deviceid."','".$Imei."','".$sim_status."','".$date."','".$problem."','".$antina."')";
	}
...
function req_info()
{
  ...
  if(document.form2.sim_status.value==0)
  {
  alert("please enter sim status") ;
  document.form2.sim_status.focus();
  return false;
  }
...
<tr>
<td height="32" align="right">Model*:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><?php
include("config.php");
